...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver mPairReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            {
                //Obtengo los parametro, aplicando un Bundle, que me indica el estado del bluetooth
                ...
                {
                    //Si se detecto que se puedo emparejar el bluetooth
                    ...
                    //Para eso se le envia como parametro la direccion(MAC) del bluetooth Arduino
